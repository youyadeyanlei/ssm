		...
		<div id="wrapper">
					...
					<ul class="nav" id="side-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a class="J_menuItem" href="employeemanage.jsp" data-index="0">员工管理</a>
								</li>
								<li>
									<a class="J_menuItem" href="attendmanage.jsp">管理</a>
								</li>
								<li>
									<a class="J_menuItem" href="salarymanage.jsp">管理</a>
								</li>
							</ul>
						</li>
			...
			<div id="page-wrapper" class="gray-bg dashbard-1">
								...
								<ul class="dropdown-menu dropdown-messages">
									<li class="m-t-xs">
										<div class="dropdown-messages-box">
											...
											<div class="media-body">
												<small class="pull-right">前端真难</small>
												<strong>前端真难</strong> 前端真难
												<br />
												<small class="text-muted">前端真难 2014.11.8</small>
											</div>
										</div>
									</li>
									<li class="divider"></li>
									<li>
										<div class="dropdown-messages-box">
											...
											<div class="media-body">
												<small class="pull-right text-navy">前端真难</small>
												<strong>前端真难</strong> 前端真难
												<br />
												<small class="text-muted">前端真难</small>
											</div>
										</div>
									</li>
									<li class="divider"></li>
									...
									<li>
										<a href="mailbox.html">
											<div>
												...
												<span class="pull-right text-muted small">0分钟前</span>
											</div>
										</a>
									</li>
									<li class="divider"></li>
				...
				<div class="row content-tabs">
					...
					<!--设置默认打开的页签1-->
						<div class="page-tabs-content">
							<a href="javascript:;" class="active J_menuTab" data-id="employeemanage.jsp">首页</a>
						</div>
					</nav>
				...
				<div class="row J_mainContent" id="content-main">
					<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="employeemanage.jsp" frameborder="0" data-id="employeemanage.jsp" seamless></iframe>
				</div>
				<div class="footer">
